...
model = dict(
    type='ViDARCurrOnly',
    save_root="/data1/cyx/OpenScene/results/vidar_pred_pc_private",
    use_grid_mask=True,
...
val_ann_pickle_root = f'data/openscene-v1.1/meta_datas/private_test_wm/private_test_wm_virtual.pkl'
